...
type CalculatorPhase = 'service-selection' | 'pass-recommendations' | 'summary-checkout';

export default function WaxPassCalculator() {
  const [phase, setPhase] = useState<CalculatorPhase>('service-selection');
    ...
    <WaxPassProvider>
      <div className="container mx-auto py-6 px-4">
        ...
        <div className="flex items-center justify-center mb-8">
          ...
          <div className={`h-0.5 w-10 mx-2 ${phase !== 'service-selection' ? 'bg-primary' : 'bg-muted'}`} />
          <div className="flex items-center space-x-3">
            <div 
              className={`rounded-full w-8 h-8 flex items-center justify-center 
        ...
        {phase === 'service-selection' && (
          <ServiceSelection onContinue={() => setPhase('pass-recommendations')} />
        )}
